<x-layout>
    <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6">
        <x-admin.setting :hedding="'Edit Post  : '.$post->title">
        <main class="max-w-3xl mx-auto  border border-gray-200 p-8 rounded-xl ">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" id="title" placeholder="Title" value="{{old('title',$post->title)}}" class="border border-gray-400 w-full p-2 rounded">
                @error('title')
            ...
            <div class="flex mb-6">
                <div class="flex-1">
                    ...
                    <input type="file" name="thumbnail" id="thumbnail" placeholder="thumbnail" value="{{old('thumbnail',$post->thumbnail)}}" class="border border-gray-400 w-full p-2 rounded">
                    @error('thumbnail')
                        <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                    @enderror
                ...
                <div>
                    <img src="/storage/{{$post->thumbnail}}" class="rounded-xl ml-6" width="200px" alt="">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug" value="{{old('slug',$post->slug)}}" class="border border-gray-400 w-full p-2 rounded">
                @error('slug')
                    <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="excerpt" id="excerpt" placeholder="Excerpt" value="{{old('excerpt',$post->excerpt)}}"  class="border border-gray-400 w-full p-2 rounded">
                @error('excerpt')
                    <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="body" id="body" placeholder="Body" cols="30" rows="6" class="border border-gray-400 w-full p-2 rounded">{{old('body',$post->body)}} </textarea>
                @error('body')
                    <p class="text-red-500 text-xs mt-2">{{$message}}</p>
                @enderror
            </div>
